# Step 6A: Deploy Cloud Run Job (Batch Processing) - FIXED VERSION
...
if config.get('deploy_batch'):
    ...
    # FIXED: Use proper INFORMATION_SCHEMA table name with project ID
    # The error was caused by missing project ID before .INFORMATION_SCHEMA.JOBS
